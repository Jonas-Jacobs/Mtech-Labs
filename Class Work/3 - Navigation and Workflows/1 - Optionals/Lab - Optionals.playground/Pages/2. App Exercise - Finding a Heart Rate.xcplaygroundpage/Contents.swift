...
let oldHR3 = 79
let oldHR4 = 70
var hrAverage: Int = oldHR1 + oldHR2 + oldHR3 + oldHR4 + hearRate! / 5
print(hrAverage)

if hearRate != nil {
    let hrAverage: Int = oldHR1 + oldHR2 + oldHR3 + oldHR4 + hearRate! / 5
    print(hrAverage)
} else { hrAverage = oldHR1 + oldHR2 + oldHR3 + oldHR4 / 4
    print(hrAverage)
}
