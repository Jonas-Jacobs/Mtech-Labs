...
func mealsAndStuff (WhatMealIsIt: String) -> String? {
    if let foodTime = meals[WhatMealIsIt] {
        print(foodTime)
    }
return nil
}
mealsAndStuff(WhatMealIsIt: "Breakfast")
mealsAndStuff(WhatMealIsIt: "Dinner")
/*:
 ...
 */
func mealLogChecker() -> [String: Any] {
    if let MealLog = UserDefaults.standard.dictionary(forKey: ""){
        print(MealLog)
    }
    return [String: Any]()
}
