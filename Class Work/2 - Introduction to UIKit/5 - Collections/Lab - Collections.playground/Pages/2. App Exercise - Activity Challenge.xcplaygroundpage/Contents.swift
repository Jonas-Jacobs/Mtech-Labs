 ...
 */
var runningChallenges: [String] = ["Sprint", "High-knee sprints"]
var walkingChallenges: [String] = ["walk 5 miles", "speed walk 3 miles"]
...
if commitments.isEmpty{
    print("Please start commiting to things :)")
