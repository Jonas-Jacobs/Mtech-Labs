...
var favoriteBook = Book(title: "Enders Game", author: "Orson", pages: 1100, price: 15.00)
print(favoriteBook)
/*:
...
var inchesHeight = Height(heightInInches: 65.0)
var centimetersHeight = Height(heightInInches: 65.0)

print(centimetersHeight.heightInInches)
print(inchesHeight.heightInCentimeters)
...
var myHeightAlso = Height(heightInInches: 72)

print(myHeight.heightInInches)
print(myHeightAlso.heightInCentimeters)
/*:
