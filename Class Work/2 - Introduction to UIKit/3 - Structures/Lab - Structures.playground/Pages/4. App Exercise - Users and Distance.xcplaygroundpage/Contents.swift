...
var jonas = User(name: "Jonas", age: 17, height: 72.0, weight: 135.0, activityLevel: 7)
print(jonas)
...
var miles = Distance(meters: 1600)
var milesAlso = Distance(meters: 1600)
print(miles.meters)
print(milesAlso.feet)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var heightInMeters = Distance(meters: 600)
var heightInFeet = Distance(meters: 600)
print(heightInFeet.meters)
print(heightInMeters.feet)
