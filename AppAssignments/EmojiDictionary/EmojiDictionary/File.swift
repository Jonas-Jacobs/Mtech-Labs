...
struct Emoji: Codable {
    ...
    static let archiveURL = documentDirectory.appendingPathComponent("Documents").appendingPathExtension("emoji.plist")
    ...
    static func loadFromFile() -> [Emoji] {
        ...
        if let retrevedEmojisData = try? Data(contentsOf: archiveURL),
           let decodedEmojis = try? propertyListDecoder.decode(Array<Emoji>.self, from: retrevedEmojisData){
